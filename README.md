...
we think it is great results becuase  it leave some space for improvization while holding enough of the original data music ideas and motives so that it can be hearde that it trained from it.
